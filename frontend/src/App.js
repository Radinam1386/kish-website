    ...
    <>
      ...
      <Routes>
        ...
        <Route element={<ProtectedRoute allowedRoles={["secretary"]} />}>
          ...
          <Route
            path="/panel/secretary/classes/:id/edit"
            element={<ClassForm />}
          />
          ...
          <Route
            path="/panel/secretary/teachers/:teacherId"
            element={<AdminTeacherDetails />}
          />

          <Route
            path="/panel/secretary/teachers/:id/edit"
            element={<AdminTeacherForm />}
          />
        ...
        <Route element={<ProtectedRoute allowedRoles={["admin"]} />}>
          ...
          <Route
            path="/panel/admin/secretaries"
            element={<AdminSecretaries />}
          />
